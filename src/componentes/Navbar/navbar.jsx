...
function Navbar() {
  ...
  return (
    ...
    <div className='contenedor_navbar'>
     <AppBar position="static" className='transparent-appbar'> {/* Agrega la clase 'transparent-appbar' aquí */}
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <img
            src={flor}
            alt="Tu Imagen"
            style={{  maxHeight: '82px', marginRight: '10px' }}
          />
           <img
            src={nombreLogo}
            alt="Tu Imagen"
            style={{ maxWidth: '106px', maxHeight: '50px' }}
          />
